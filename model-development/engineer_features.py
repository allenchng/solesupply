...
def preproc_data(data_path):
        ...
        """ Aggregates sneaker sale transactions on a daily time scale.

        Args:
            data_path: Path to csv containing sneaker transactions.

        Returns:
            daily_count: A dataframe of total daily sneaker sale transactions.
        """
        ...
        # Clean dates to be in Year - Month - Day format
        ...
        # Aggregate across day and sum number of transactions
...
def make_data(path, days_rolling, days_forward):
        ...
        """ Pre-processes data for modeling. Engineers features on date information, rolling metrics, and sneaker brand information.

        Args:
                path: Path to csv containing sneaker transactions.
                days_rolling: Integer representing how many rolling days into the past to compute metrics for. Eg. days_rolling = 7 aggregates sales over the last week.
                days_forward: Integer representing the day into the future to predict. Eg. days_forward = 7 predicts one week from today.

        Returns:
                merged_release: A dataframe of features and predictors for modeling.
        """
